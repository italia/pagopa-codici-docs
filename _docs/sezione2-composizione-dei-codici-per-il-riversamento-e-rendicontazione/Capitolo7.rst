...
.. container::
   ...
   7. Flusso di Rendicontazione |image1| ============================
...
+--------+------+-----------------------------------------------------+
| **col  | -  L | indica il livello di indentazione del dato al fine  |
| onna** | iv\* | di rendere evidenti le strutture che contengono     |
...
+--------+------+-----------------------------------------------------+
| **col  | -  G | indica il genere (tipo) del dato da utilizzare; può |
| onna** | en\* | assumere i seguenti valori:                         |
|        |      |                                                     |
...
|        |      | -  n - dato numerico.                               |
+--------+------+-----------------------------------------------------+
| **col  | -  O | indica le “occorrenze” del dato nel formato         |
| onna** | cc\* | **min..max.**                                       |
+--------+------+-----------------------------------------------------+
| **col  | -  L | indica la lunghezza massima del dato nel formato    |
| onna** | en\* | **min..max;** nel caso si tratti di una lunghezza   |
...
| ntificativoFlusso |    |    | .  | .. | generazione e trasmissione |
|                   |    |    | .1 | 35 | del flusso di              |
|                   |    |    |    |    | riversamento.              |
|                   |    |    |    |    |                            |
|                   |    |    |    |    | Deve essere univoco        |
...
|                   |    |    |    |    | :ref:`7.2 <sta nd-del-da   |
|                   |    |    |    |    | to-identificativo flusso>` |
+-------------------+----+----+----+----+----------------------------+
| dataOraFlusso     | 1  | an | 1  | 19 | Indica la data e ora di    |
|                   |    |    | .  |    | creazione del flusso,      |
|                   |    |    | .1 |    | secondo il formato ISO     |
|                   |    |    |    |    | 8601                       |
|                   |    |    |    |    |                            |
|                   |    |    |    |    | **[YYYY]-[MM]-[D           |
|                   |    |    |    |    | D]T[hh]:[mm]:[ss]**        |
...
| nivocoRegolamento |    |    | .  | .. | prestatore di servizi di   |
|                   |    |    | .1 | 35 | pagamento all’operazione   |
...
| tificativoUnivoco |    |    | .  |    | descrive la codifica       |
|                   |    |    | .1 |    | utilizzata per individuare |
...
| tificativoUnivoco |    |    | .  | .. | contenere il codice        |
|                   |    |    | .1 | 35 | fiscale o la partita IVA,  |
...
| minazioneMittente |    |    | .  | .. | del prestatore di servizi  |
|                   |    |    | .1 | 70 | di pagamento mittente che  |
|                   |    |    |    |    | genera il flusso.          |
+-------------------+----+----+----+----+----------------------------+
| codiceBicBa       | 2  | an | 0  | 1  | Contiene il codice BIC del |
| ncaDiRiversamento |    |    | .  | .. | PSP che ha generato il     |
|                   |    |    | .1 | 35 | SEPA Credit Transfer di    |
|                   |    |    |    |    | riversamento. Corrisponde  |
|                   |    |    |    |    | al dato AT-09 del SCT.     |
+-------------------+----+----+----+----+----------------------------+
| istitutoRicevente | 1  | s  | 1  |    | Aggregazione relativa      |
|                   |    |    | .  |    | all’Ente Creditore         |
|                   |    |    | .1 |    | destinatario del flusso.   |
+-------------------+----+----+----+----+----------------------------+
| identificativ     | 2  | s  | 1  |    | Aggregazione che riporta   |
| oUnivocoRicevente |    |    | .  |    | le informazioni            |
|                   |    |    | .1 |    | concernenti                |
...
+-------------------+----+----+----+----+----------------------------+
| tipoIden          | 3  | an | 1  | 1  | Campo alfanumerico che     |
| tificativoUnivoco |    |    | .  |    | indica la natura dell’Ente |
|                   |    |    | .1 |    | Creditore; se presente     |
|                   |    |    |    |    | deve assumere il valore    |
|                   |    |    |    |    | **‘G’**, Identificativo    |
|                   |    |    |    |    | fiscale Persona Giuridica. |
+-------------------+----+----+----+----+----------------------------+
| codiceIden        | 3  | an | 1  | 1  | Campo alfanumerico         |
| tificativoUnivoco |    |    | .  | .. | contenente il codice       |
|                   |    |    | .1 | 35 | fiscale dell’Ente          |
|                   |    |    |    |    | Creditore destinatario del |
|                   |    |    |    |    | flusso.                    |
+-------------------+----+----+----+----+----------------------------+
| denom             | 2  | an | 0  | 1  | Contiene la denominazione  |
| inazioneRicevente |    |    | .  | .. | dell’Ente Creditore che    |
|                   |    |    | .1 | 70 | riceve il flusso.          |
+-------------------+----+----+----+----+----------------------------+
| nume              | 1  | n  | 1  | 1  | Numero dei pagamenti       |
| roTotalePagamenti |    |    | .  | .. | presenti nel flusso.       |
|                   |    |    | .1 | 15 |                            |
+-------------------+----+----+----+----+----------------------------+
| impor             | 1  | n  | 1  | 1  | Importo totale dei         |
| toTotalePagamenti |    |    | .  | .. | pagamenti presenti nel     |
|                   |    |    | .1 | 18 | flusso. Deve coincidere    |
...
| UnivocoVersamento |    |    | .  | .. | cui si riferisce il        |
|                   |    |    | .1 | 35 | pagamento rendicontato nel |
|                   |    |    |    |    | flusso.                    |
+-------------------+----+----+----+----+----------------------------+
| identificativoU   | 2  | an | 1  | 1  | Riferimento univoco        |
| nivocoRiscossione |    |    | .  | .. | dell’operazione assegnato  |
|                   |    |    | .1 | 35 | al pagamento dal           |
|                   |    |    |    |    | Prestatore dei servizi di  |
|                   |    |    |    |    | Pagamento                  |
+-------------------+----+----+----+----+----------------------------+
| indiceDat         | 2  | n  | 0  | 1  | Indice dell’occorrenza del |
| iSingoloPagamento |    |    | .  |    | pagamento all’interno      |
|                   |    |    | .1 |    | della struttura            |
|                   |    |    |    |    | datiSingoloPagamento della |
|                   |    |    |    |    | Ricevuta Telematica.       |
+-------------------+----+----+----+----+----------------------------+
| sin               | 2  | an | 1  | 3  | Campo numerico indicante   |
| goloImportoPagato |    |    | .  | .. | l’importo relativo alla    |
|                   |    |    | .1 | 12 | somma pagata o revocata.   |
|                   |    |    |    |    | Deve essere diverso da 0.  |
|                   |    |    |    |    |                            |
|                   |    |    |    |    | Qualora il singolo importo |
|                   |    |    |    |    | pagato è riferito ad un    |
|                   |    |    |    |    | pagamento revocato (dato c |
|                   |    |    |    |    | odiceEsitoSingoloPagamento |
|                   |    |    |    |    | =3) deve assumere un       |
|                   |    |    |    |    | valore negativo.           |
+-------------------+----+----+----+----+----------------------------+
| codiceEsit        | 2  | n  | 1  | 1  | Campo numerico indicante   |
| oSingoloPagamento |    |    | .  |    | l’esito del pagamento. Può |
|                   |    |    | .1 |    | assumere i seguenti        |
|                   |    |    |    |    | valori:                    |
|                   |    |    |    |    |                            |
|                   |    |    |    |    | -  **0** = Pagamento       |
|                   |    |    |    |    |    eseguito                |
...
| oSingoloPagamento |    |    | .  |    | stato disposto o revocato  |
|                   |    |    | .1 |    | il pagamento, nel formato  |
|                   |    |    |    |    | ISO 8601 [YYYY]-[MM]-[DD]. |
+-------------------+----+----+----+----+----------------------------+
...
2.1.4 <http://pagopa-specifichepagamenti.readthedocs.io/it/latest/_docs/Capitolo2.html#storno-del-pagamento>`__
e
`2.3 <http://pagopa-specifichepagamenti.readthedocs.io/it/latest/_docs/Capitolo2.html#revoca-della-ricevuta-telematica>`__
...
.. container::
   :name: precisazioni-sulla-colonna-contenutodella-tabella-4

   7.1 Precisazioni sulla colonna “contenuto”della Tabella 4 |image2|
   ---------------------------------------------------------
...
:ref:`vedi capitolo 6 <riversamento-agli-enti-creditori>`);
...
5.3.2 <http://pagopa-specifichepagamenti.readthedocs.io/it/latest/_docs/Capitolo5.html#ricevuta-telematica-rt>`__
...
Credit Transfer (ref:cfr. capitolo 6 <riversamento-agli-enti-creditori>)
ed anche nel flusso di rendicontazione di cui ref:al capitolo 7
<flusso-di-rendicontazione> (cfr. Tabella 4 - Flusso per la
rendicontazione -Schema dati), sarà adottata la seguente struttura

**<data regolamento> <istituto mittente>“-”<flusso>**

dove i componenti sopra indicati assumono il seguente significato:

-  **<data regolamento>** contiene le stesse informazioni dell’elemento
   dataRegolamento del file XML;

- **<istituto mittente>** contiene il codice del PSP che predispone il
flusso. Si precisa che tale codice deve coincidere con il dato
...
\_docs/Capitolo5.html#catalogo-dati-informativi> <>`__ della Sezione II
dell’Allegato B alle Linee guida;

-  **"-"** dato fisso;

- **<flusso>** stringa alfanumerica che, insieme alle informazioni sopra
indicate, consente di individuare univocamente il flusso stesso. I
