...
.. container::
   ...
   4. Operazione di trasferimento fondi |image1|
   ====================================
...
Rulebook* pubblicato da EPC [1]_).
...
.. container::
   ...
   4.2 Utilizzo del bollettino di conto corrente postale |image2|
   -----------------------------------------------------
...
.. container::
   :name: rifiuto-del-sepa-credit-transfer

   4.3 Rifiuto del SEPA Credit Transfer |image3|
   ------------------------------------
...
**Tabella** **3 – Dati da inviare da parte del PSP in caso di REJECT del
SCT**

+------------------+--------------------------------------------------+
| **Dato**         | **Contenuto**                                    |
+==================+==================================================+
| Identificativo   | così come indicato nella componente <istituto    |
| del PSP          | mittente> del dato identificativoFlusso,         |
|                  | :ref:`v                                          |
|                  | edi § 7.2 <stand-del-dato-identificativoflusso>` |
+------------------+--------------------------------------------------+
| Denominazione    |                                                  |
| del PSP          |                                                  |
+------------------+--------------------------------------------------+
...
| Creditore        |                                                  |
+------------------+--------------------------------------------------+
| Data             | elemento dataOraMessaggioRicevuta                |
| dell'emissione   |                                                  |
| della RT         |                                                  |
+------------------+--------------------------------------------------+
| IBAN di          | attributo AT-20 IBAN of the account of the       |
| accredito del    | Beneficiary                                      |
| SCT              |                                                  |
+------------------+--------------------------------------------------+
...
+------------------+--------------------------------------------------+
| TRN del SCT      | attributo AT-43 Originator Bank's reference      |
|                  | number                                           |
+------------------+--------------------------------------------------+
| *EndToEndId* del | attributo AT-41 Originator's reference           |
| SCT              |                                                  |
+------------------+--------------------------------------------------+
| Motivo del       | attributo AT-R3 reason code for non-acceptance   |
| messaggio di     |                                                  |
| REJECT           |                                                  |
+------------------+--------------------------------------------------+
| Note             | a cura del PSP                                   |
